...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <a class="btn btn-primary btn-xl text-uppercase " href="service.php">Order Service</a>
        </div>
    </header>
    <!-- Services-->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <button onclick="window.location.href = 'roomSelectPage.php';" class="btn btn-primary" data-dismiss="modal" type="button"><i class="fas fa-times mr-1"></i>Booking Your Stay</button>
                                <!--Edit here na tap for button address-->
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <p>
                                    <p><b>Business Meeting:</b> Put innovative, flexible solutions to work for you
