...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="room_type_3.css">
    ...
    <div class="container">
      ...
      <div clas="w3-about-grids">
        <div class="row">
          ...
          <div class="col w3-about-left">
            <h5>OCCUPANCY</h5>
            <p>Two adults and two children under 12 years old<br> Cribs are available upon request and subject to availability</p>
          </div>
          <div class="col w3-about-left">
            <h5>LOCATION</h5>
  ...
  <div>
    <div class="row">
      <div class="col price-mobamus">
        <div class="price-top">
          <img src="./picHotelRoom/detail_type_3.png" alt="pic1" class="img-fluid" />
          </a>
        </div>
      </div>
      <div class="col price-mobamus">
        <div class="price-top">
          <img src="./picHotelRoom/detail_type_3_2.png" alt="pic3_2" class="img-fluid" />
          </a>
        </div>
      ...
      <div class="col price-mobamus">
        <div class="price-top">
          <img src="./picHotelRoom/detail_type_3_3.png" alt="pic3_3" class="img-fluid" />
          </a>
        </div>
