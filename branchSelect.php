  ...
  <div class="bd-example">
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item drk active">
          <img class=" img-fluid" src="./picHotelRoom/branch1.jpg" alt="First slide">
          <div class="carousel-caption d-block">
            <p>CALINA HOTEL Phuket</p>
            <a target="_blank" href="login_check.php" class="btn btn-danger btn-lg btn-rounded">Explore</a>
          </div>
        </div>
        <div class="carousel-item drk">
          <img class="img-fluid" src="./picHotelRoom/branch2.jpg" alt="Second slide">
          <div class="carousel-caption d-block">
            <p>CALINA HOTEL Pattaya</p>
            <a target="_blank" href="login_check.php" class="btn btn-danger btn-lg btn-rounded">Explore</a>
          </div>
        </div>
        <div class="carousel-item drk">
          <img class="img-fluid" href="http://google.com" src="./picHotelRoom/branch3.jpg" alt="Third slide">
          <div class="carousel-caption d-block">
            <p>CALINA HOTEL Huahin</p>
            <a target="_blank" href="login_check.php" class="btn btn-danger btn-lg btn-rounded">Explore</a>
          </div>
        </div>
      </div>
    ...
    <div class="selectBranch">
        <form name="selectbranch" method="POST" action="login_check.php">
            ...
            <input class="btn btn-primary" type="submit" name="submit" value="Explore">
        </form>
    </div>
    ...
    <div class=grid>
      <figure class="effect-apollo">
        <a class="example-image-link" href="room_type3.php" data-lightbox="example-set">
          <img src="./picHotelRoom/Phuket.jpg" class=" img-fluid">
          <figcaption>
            <h2>PHUKET</h2>
        ...
        <div class=grid>
          <figure class="effect-apollo">
            <a class="example-image-link" href="room_type1.php">
              <img src="./picHotelRoom/Pattaya.jpg" class=" float-left img-fluid">
              <figcaption>
                <h2>PATTAYA</h2>
                <p>Second branch</p>
              </figcaption>
        ...
        <div class=grid>
          <figure class="effect-apollo">
            <a class="example-image-link" href="room_type2.php">
              <img src="./picHotelRoom/Huahin.jpg" class="float-right img-fluid">
              <figcaption>
                <h2>HUAHIN</h2>
                <p>Newest branch</p>
              </figcaption>
