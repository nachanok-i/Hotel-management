...
--
-- Host: localhost
-- Generation Time: Apr 20, 2020 at 07:51 PM
...
--
-- Constraints for table `tableTest2`
--
ALTER TABLE `tableTest2`
  ADD CONSTRAINT `tableTest2_ibfk_2` FOREIGN KEY (`column1_FK`) REFERENCES `tableTest1` (`column1`);
